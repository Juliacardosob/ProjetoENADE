        ...
        <form method="POST"class="perfil-box" >
                <div class="perfil-conteudo">
                    ...
                    <div class="loginInput-container cadastroInput">
                        ...
                        <input type="password" name="password" class="login-input " placeholder="Alterar senha">
                    ...
                    <div class="loginInput-container cadastroInput">
                        ...
                        <input type="password" name="password" class="login-input " placeholder="Confirme senha">
                    </div>

                    <button style="display: flex; align-items:center; justify-content:center; gap:10px" class="btn-form btn-atualizar"><i class="material-icons">check_circle</i>
                        <p>Atualizar dados</p>
                    </button>
                </div>
        </form>
